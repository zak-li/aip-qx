...
Each auditor $i \in N$ observes evidence $E$ and must submit a vote $v_i \in \{FRAUD, LEGITIMATE\}$ using a cryptographic Commit-Reveal scheme to prevent information cascades (free-riding).
