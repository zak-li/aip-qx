            ...
            return [
                {
                    ...
                    "actorDN": "CN=Admin@bnpparibas.finance-trust.com,OU=admin",
                    "action": "TOKENISE",
                    "fromOwner": "",
                    "toOwner": "CN=Admin@bnpparibas.finance-trust.com,OU=admin",
                    "amount": 50000000,
                ...
                },
                {
                    ...
                    "actorDN": "CN=Admin@bnpparibas.finance-trust.com,OU=admin",
                    "action": "TRANSFERE",
                    "fromOwner": "CN=Admin@bnpparibas.finance-trust.com,OU=admin",
...
async def test_user_thomas(async_session: AsyncSession, test_org: Organization) -> User:
    ...
    user = User(
        id=THOMAS_USER_ID,
        org_id=BNP_ORG_ID,
        email="thomas.martin@bnpparibas.fr",
